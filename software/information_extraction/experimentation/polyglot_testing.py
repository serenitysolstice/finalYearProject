...
xample = ("A CURIOUS EXPERIMENT. A distinguished German biologist—Dr. Weisman —is making experiments in the way of trying to show that artificial modifications made "
